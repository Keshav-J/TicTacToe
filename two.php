...
<div class="twoDiv" ng-controller="twoCtrl">

	<div class="player center">
		<div class="play">
			<label ng-show="p2"> Player 1 </label>
			<label ng-show="!p2" class="active"> Player 1 </label>
		...
		<div class="play">
			<label ng-show="p2" class="active"> Player 2 </label>
			<label ng-show="!p2"> Player 2 </label>
